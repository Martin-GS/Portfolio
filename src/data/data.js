  ...
  projects: [
    {
      ...
      description: `<strong>Description :</strong><br /> Mon portfolio, développé en <i>vanilla JavaScript</i> : l'intégralité du site été développée en JavaScript. C'est le site sur lequel vous vous trouvez en ce moment.`,
    ...
    },
    {
      ...
      description: "<strong>Description :</strong><br /> <i>To-do list</i> (liste de tâches) développée en <i>vanilla JavaScript</i> : l'intégralité du site été développée en JavaScript.",
      technos: "<strong>Technos :</strong><br /> HTML, CSS, JavaScript",
      status: "<strong>Status :</strong><br /> v1 finalisée et déployée",
    ...
    },
    {
      ...
      description: `<strong>Description :</strong><br /> <i>Wishlist</i> permettant de créer des listes d'articles sous forme de liens (vers les annonces des sites marchands) et affichant leurs images. <a class="plusdinfos" href="https://github.com/Martin-GS/WishList#readme" target="_blank" rel="noopener noreferrer">+d'infos</a>`,
