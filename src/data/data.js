const data = {
  ...
  about: {
    ...
    resume: `<p><span class="emphasis">Issu d'une école des Beaux-Arts et d'une formation en Développement FullStack JavaScript</span>, je suis passionné depuis mon plus jeune âge par l'art et les nouvelles technologies.</p><p><span class="emphasis">Je me suis spécialisé en développement Front-End</span>, métier qui a attiré mon attention de par son aspect artisanal, associant technicité, créativité et design.</p><p><span class="emphasis">Aujourd'hui je suis à l'écoute de nouvelles opportunités</span> me permettant d'apporter mon expertise (tout en continuant à apprendre) sur des projets challengeants et innovants, au sein d'une équipe dynamique et bienveillante.</p>`,
  ...
  projects: [
    {
      ...
      description: `<strong>Description :</strong><br /> Mon portfolio, développé en <i>vanilla JavaScript</i>. <a class="plusdinfos" href="https://github.com/Martin-GS/Portfolio#readme" target="_blank" rel="noopener noreferrer">+d'infos</a>`,
    ...
    },
    {
      ...
      description: `<strong>Description :</strong><br /> <i>Wish-list</i> permettant d'importer les images depuis les sites marchands. <a class="plusdinfos" href="https://github.com/Martin-GS/WishList#readme" target="_blank" rel="noopener noreferrer">+d'infos</a>`,
    ...
    },
    {
      ...
      description: `<strong>Description :</strong><br /> Mon carnet de notes de développement web et mobile. <a class="plusdinfos" href="https://github.com/Martin-GS/DevStack#readme" target="_blank" rel="noopener noreferrer">+d'infos</a>`,
      technos: "<strong>Technos :</strong><br /> HTML, CSS, JavaScript",
      status: "<strong>Status :</strong><br /> v1 finalisée et déployée",
