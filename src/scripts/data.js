const data = {
  ...
  about: {
    ...
    resume: `<p>Issu d'une école des Beaux-Arts et d'une formation en développement web et web mobile (FullStack JavaScript), je suis passionné depuis mon plus jeune âge par l'art et les nouvelles technologies.</p><p>Je me suis spécialisé en développement Front-End, qui allie à la fois technicité et création. Je vois dans ce métier une forme d'<i>artisanat</i> où, à partir d'une feuille blanche (ou plutôt un fichier vide), on peut créer une application.</p><p>En outre, ayant suivi une formation en développement FullStack, j'ai eu la occasion  de travailler sur des projets Back-End, et ainsi découvrir Node, Express, PostgreSQL, SQL, etc.</p>`,
  ...
  projects: [
    ...
    {
      title: "WishList",
      description: "Application web permettant de créer des listes d'articles en important les images depuis les sites marchands. J'ai fait partie d'une équipe de 4 développeurs ; j'y ai participé en tant que développeur Front-End",
    ...
    {
      title: "DevStack",
      description: "Mon carnet de notes de développement web et mobile.",
