const data = {
  ...
  about: {
    ...
    resume: `<p>Issu d'une école des Beaux-Arts et d'une formation en développement web et web mobile (FullStack JavaScript), je suis passionné depuis mon plus jeune âge par l'art et les nouvelles technologies.</p><p>Je me suis spécialisé en développement Front-End, qui allie à la fois technicité et création. C'est justement cela qui m'a attiré dans ce métier: son aspect artisanal, où savoir-faire, créativité et (beaucoup de) patience permettent de créer à partir d'une feuille blanche.</p><p>En outre, ayant suivi une formation en développement FullStack, j'ai eu l'occasion  de travailler sur des projets Back-End, et ainsi découvrir Node, Express, PostgreSQL, SQL, etc.</p>`,
